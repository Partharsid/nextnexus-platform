...
export const RejectionMessage = () => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      <H3>Thank you so much for your interest in Next Nexus X!</H3>
      <H3>
      ...
      <H3>
        Next Nexus has seen record-breaking levels of interest this year and our
        ...
        year – with a goal of making Next Nexus accessible to all who want to
        attend.
      </H3>
      <H3>
        We encourage you to apply again in the next hackathon! We will have many
        more cool upcoming events. Make sure to stay up to date with Next Nexus
        through{' '}
