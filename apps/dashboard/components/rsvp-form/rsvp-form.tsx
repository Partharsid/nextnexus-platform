...
import { H2, H3, Text } from '@nextnexus/ui';
import { GrayBox } from '../gray-box/gray-box';
import { Button, Checkbox, DatePicker } from '@nextnexus/ui-kit-2023';
...
const ERROR_STRING =
  'An error occured while trying to query Discord status. If this error persists, please contact team@nextnexus.com for further assistance';
