import { GradientSpan, H5, Link, Text } from '@nextnexus/ui';
    ...
    <StyledDesktopNavbar>
      ...
      <RightMenuDiv>
        ...
        <DropdownMenu>
          ...
          <DropdownContent>
            <DropdownContentItem>
              <Link href="https://2023.nextnexus.com">
                <DropdownText>Next Nexus 2023</DropdownText>
              </Link>
            </DropdownContentItem>
            <DropdownContentItem>
