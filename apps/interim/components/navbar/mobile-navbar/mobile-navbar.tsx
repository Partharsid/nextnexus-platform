    ...
    <nav role="navigation">
      <div className={`${ham.menuToggle}`}>
        ...
        <ul className={`${ham.menu}`}>
          <a href="https://nextnexus.com/">
            <li>Overview</li>
          </a>
          <a href="https://team.nextnexus.com">
            <li>Join our team</li>
          </a>
          <DropdownMenu>
