...
import { H2, H5, Label, Text, AccordionItem2023 } from '@nextnexus/ui';
import { GlowSpan, ColorSpan, ColorSpanBold } from '@nextnexus/ui-kit-2023';
      ...
      <Text>
        <ColorSpan color={Colors2023.BLUE.STANDARD}>
          ...
          <ColorSpanBold color={Colors2023.BLUE.STANDARD}>
            <a href="mailto:team@nextnexus.com">team@nextnexus.com</a>
          </ColorSpanBold>{' '}
