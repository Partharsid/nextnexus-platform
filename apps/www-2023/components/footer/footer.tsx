...
import { ColorSpanBold } from '@nextnexus/ui-kit-2023';
  ...
  const socialMedias: { href: string; src: string; alt: string }[] = [
    {
      ...
      alt: 'LinkedIn',
      href: 'https://www.linkedin.com/company/nextnexus/',
    },
    {
      src: '/img/logos/twitter.svg',
      alt: 'Twitter',
      href: 'https://twitter.com/nextnexusofficial',
    },
    {
      src: '/img/logos/facebook.svg',
      alt: 'Facebook',
      href: 'https://www.facebook.com/nextnexusofficial/',
    },
    {
      src: '/img/logos/instagram.svg',
      alt: 'Instagram',
      href: 'https://www.instagram.com/nextnexusofficial/',
    },
    {
  ...
  const accessible: { href: string; src: string; alt: string }[] = [
    {
      ...
      href: 'https://www.notion.so/nextnexus23/Accessibility-Statement-0122349b14794a5bb3397c487316d1cb',
    },
  ];
  const Vercel: { href: string; src: string; alt: string }[] = [
    {
      ...
      alt: 'Vercel',
      href: 'https://www.vercel.com/?utm_source=nextnexus&utm_campaign=oss',
    },
  ];
    ...
    <FooterWrapper>
      <SocialMediaContainer>
        ...
        <ColorSpanBold color={Colors2023.GRAY.LIGHT}>
          <Link href="https://www.notion.so/nextnexus23/Accessibility-Statement-0122349b14794a5bb3397c487316d1cb">
